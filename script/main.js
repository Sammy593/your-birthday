...
// Importar los datos para personalizar e insertarlos en la página
const fetchData = () => {
  fetch("customize.json")
    ...
    .then((data) => {
      ...
      dataArr.map((customData) => {
        if (data[customData] !== "") {
          if (customData === "imagePath") {
            ...
            data[customData].forEach((font) => {
              ...
              // Establecer la fuente del cuerpo
        ...
        // Verificar si la iteración ha terminado
        // Ejecutar la animación si es así
...
const animationTimeline = () => {
  // Separar los caracteres que necesitan ser animados individualmente
...
// Ejecutar fetch y animación en secuencia
fetchData();
